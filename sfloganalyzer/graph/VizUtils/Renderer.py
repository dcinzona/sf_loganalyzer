...
from sfloganalyzer.Operations.Cluster import Cluster
from sfloganalyzer.Operations.OpUtils import dynamicDict
...
class Renderer:
    ...
    def processStack(self, opsList: OperationsList):
        ...
        self.nodeUtils = RenderUtils.Node(self.operations, self.options)
